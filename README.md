> _Project made for studies pourposes_
## 🎯Type of project:
...
- Springboot as framwework (Maven project),
- MongoDB as a NoSQL Database
- *Others:* MongoDB Compass (Mongo interface) and Postman (API tests)

### 🗃️*The project was organized in layers:
