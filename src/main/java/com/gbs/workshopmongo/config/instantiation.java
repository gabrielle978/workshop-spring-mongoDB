...
public class instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1= new Post(null, sdf.parse("21/03/2023"), "Bora viajar", "Me aguarde Bahia!", maria );
        Post post2= new Post(null, sdf.parse("02/02/2026"), "Bom dia Brasil", "Ansiosa para a prova de hoje!", gabi );
